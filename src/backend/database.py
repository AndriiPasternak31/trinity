...
class DatabaseManager:
    ...
    def authorize_execution_dispatch(self, execution_id: str, agent_name: str) -> bool:
        return self._schedule_ops.authorize_execution_dispatch(execution_id, agent_name)
